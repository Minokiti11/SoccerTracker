...
# tracking----------------------------------------------------------------------------
TARGET_VIDEO_PATH = f"{HOME}/local_soccer_tracker/out/tracking/video2.mp4"
...
def yolobbox2bbox(x, y, w, h, img_width, img_height):
    """
    Transform yolo bbox in xy-widht-height convention(x and y is top_left)
...
# final---------------------------------------------------------------------------------
# print("players_tracking and ball possesion")
# from datetime import datetime as dt

# tdatetime = dt.now()
# tstr = tdatetime.strftime('%Y:%m:%d_%H:%M:%S')

# TARGET_VIDEO_PATH = f"{HOME}/local_soccer_tracker/out/final/video2.mp4"
...
#         prev_tracked_detections = tracked_detections
#     else:
#         tracked_detections = prev_tracked_detections
